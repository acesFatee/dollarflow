  ...
  return (
    <>
        ...
        <div className="quick-buttons grid grid-cols-4 gap-4">
          ...
          >
            <img width={20} src="/expense.png" alt="Create Expense" />
          ...
          <button
            ...
            className="btn flex items-center justify-center bg-base-200 rounded-md shadow-sm px-4 py-2 space-x-2"
          >
            <img width={20} src="/income.png" alt="Add Income" />
          ...
          <button
            ...
            className="btn flex items-center justify-center bg-base-200 rounded-md shadow-sm px-4 py-2 space-x-2"
          >
            <img width={20} src="/category.png" alt="Create Category" />
          ...
          {theme === "dark" && <button
            ...
            className="btn flex items-center justify-center bg-base-200 rounded-md shadow-sm px-4 py-2 space-x-2"
          >
            <img width={20} src="/sun.png" alt="Light Mode" />
          ...
          {theme === "light" && <button
            ...
            className="btn flex items-center justify-center bg-base-200 rounded-md shadow-sm px-4 py-2 space-x-2"
          >
            <img width={20} src="/moon.png" alt="Dark Mode" />
